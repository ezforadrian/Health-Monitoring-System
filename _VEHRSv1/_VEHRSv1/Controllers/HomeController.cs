...
namespace _VEHRSv1.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, SignInManager<ApplicationUser> signInManager, UserManager<ApplicationUser> userManager, IAccountManagementRepository enrollmentRepository)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> AuthenticateUser([FromBody] vm_LoginView model)
        {
            var rolename_ = "";
            var jsonData = new vm_ServerResponseGeneric
            {
        ...
        public async Task<IActionResult> LoginSuccess()
        {
            ...
            if (roles.Contains("SYSADMIN") || roles.Contains("APPADMIN") || roles.Contains("USER"))
            {
